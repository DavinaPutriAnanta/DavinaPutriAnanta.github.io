...
<head>
  ...
  <style>
    ...
    #navbar a:hover {
      color: #ff3366; /* Darker pink on hover */
    }

    .dark-mode #navbar {
      background-color: #660066; /* Darker pink navbar */
    }
    ...
    .dark-mode .form-container {
      background-color: #4d004d; /* Dark pink for form in dark mode */
    }
    ...
    .form-container input:focus {
      border-color: #ff3366; /* Pink border on focus */
      outline: none;
    }
    ...
    .form-container button {
      ...
      padding: 10px;
      margin-top: 10px;
      background-color: #ff3366; /* Pink button */
      color: white;
      border: none;
      border-radius: 5px;
      font-size: 16px;
    ...
    .dark-mode .form-container .delete-button {
      background-color: #c82333; /* Darker red in dark mode */
    }

    .dark-mode .form-container .delete-button:hover {
      background-color: #b21f2a; /* Even darker red on hover */
    }
