...
<head>
    ...
    <style>
        ...
        body.dark-mode .product-table {
            background-color: #4d004d; /* Dark pink for product table */
            color: #ff99cc; /* Light pink text */
        }
        ...
        body.dark-mode .product-table th {
            background-color: #663399; /* Darker background for table headers in dark mode */
        }

        .action-buttons a {
            margin: 5px;
            padding: 5px 10px;
            background-color: #ff3366; /* Pink background for action buttons */
            color: white;
            text-decoration: none;
            border-radius: 5px;
            transition: background-color 0.3s;
        ...
        body.dark-mode .action-buttons a {
            background-color: #dc3545; /* Red background for delete button in dark mode */
        }
        ...
        body.dark-mode .action-buttons a:hover {
            background-color: #c82333; /* Dark mode hover effect */
        }
